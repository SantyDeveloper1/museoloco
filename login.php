...
<head>
   ...
   <link rel="stylesheet" href="login1/login/css/bootstrap.css">
   <link rel="stylesheet" type="text/css" href="login1/login/css/style.css">
   <link href="https://fonts.googleapis.com/css?family=Poppins:600&display=swap" rel="stylesheet">
   <title>Inicio de sesión</title>
</head>

<body>
   <img class="wave" src="login1/login/img/wave.png">
   <div class="container">
      <div class="img">
         <img src="login1/login/img/bg.svg">
      </div>
      <div class="login-content">
      <form id="login_php" class="form-horizontal form-bordered form-control-borderless">
            <img src="login1/login/img/avatar.svg">
   ...
   <script src="lib2/login.js?v=04225"></script>
</body>
</html>