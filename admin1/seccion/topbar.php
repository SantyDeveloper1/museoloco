        ...
        <div class="container-fluid topbar bg-light px-5 d-none d-lg-block">
            <div class="row gx-0 align-items-center">
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    ...
                    <a href="#"><small class="me-3 text-dark"><i class="fa fa-user text-primary me-2"></i>Welcome </small></a>
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle text-dark" data-bs-toggle="dropdown"><small><i class="fa fa-home text-primary me-2"></i> My Dashboard</small></a>
                            <div class="dropdown-menu rounded">
                                <a href="#" class="dropdown-item"><i class="fas fa-user-alt me-2"></i> Mi Perfil</a>
                                <a href="#" class="dropdown-item"><i class="fas fa-cog me-2"></i> Cambiar Contraseña</a>
                                <a href="#" class="dropdown-item"><i class="fas fa-power-off me-2"></i> Cerrar Sesion</a>
                            </div>
                        </div>
                    </div>
                </div>
