        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Piedra de Saywite</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.php">Casa</a></li>
                        <li class="breadcrumb-item active text-primary">Detalle de Saywite</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-lg-8 text-center">
                <div class="audio-container p-4 rounded shadow">
                    <h4 class="mb-3 text-white">Escucha el enigma de la Piedra de Saywite</h4>
                    <audio controls class="w-100">
                        <source src="audio/saywite.mp3" type="audio/mpeg">
        ...
        <div class="row g-5 align-items-center">
                ...
                <div class="accordion accordion-flush bg-light rounded p-5" id="accordionFlushSection">
                    <div class="accordion-item rounded-top">
                        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                            <h1 class="display-5 mb-4">Piedra de Saywite</h1>
                            <p class="mb-4">
                                La <strong>Piedra de Saywite</strong> es un monumento arqueológico único situado en la región de <strong>Apurímac, Perú</strong>. Conocida por su diseño en forma circular y los cientos de figuras geométricas y canales tallados en su superficie, es uno de los más grandes misterios de la civilización incaica.
                            </p>
                            <p class="mb-4">
                                Se cree que la piedra pudo haber sido utilizada para ceremonias relacionadas con el agua, siendo un centro de culto y rituales. Su propósito exacto sigue siendo un tema de debate entre los arqueólogos, pero muchos coinciden en que estuvo vinculada a los sistemas hidráulicos y agrícolas de los antiguos peruanos.
                            </p>
                            <p class="mb-4">
                                Actualmente, la Piedra de Saywite es un atractivo turístico, conocida por sus enigmáticas figuras que siguen fascinando a los visitantes que llegan a la región de Apurímac. Además, se considera un símbolo de la ingeniería y el conocimiento de los antiguos habitantes de los Andes.
                            </p>
                            <p class="mb-0">
                                📍 <strong>Ubicación:</strong> Distrito de Curahuasi, Provincia de Abancay, Apurímac, Perú.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner bg-primary rounded">
                        <div class="carousel-item active">
                            <img src="img/saywite3.jpg" class="d-block w-100 img-fluid" alt="Imagen 1">
                        </div>
                        <div class="carousel-item">
                            <img src="img/saywite1.jpeg" class="d-block w-100 img-fluid" alt="Imagen 2">
                        </div>
                        <div class="carousel-item">
                            <img src="img/saywite2.jpg" class="d-block w-100 img-fluid" alt="Imagen 3">
                        </div>
                    </div>
            ...
            <div class="text-center mt-3">
                ...
                <div class="text-center mt-2">
                    <a href="https://maps.app.goo.gl/HEKsrMupKcbb2TZx6" target="_blank" class="btn btn-primary">
                    <!--<a href="https://www.google.com/maps/dir/?api=1&destination=-13.547176,-72.8031982" target="_blank" class="btn btn-primary">-->
            ...
            <div class="video-container p-4 rounded shadow">
                ...
                <div class="video-wrapper">
                    <iframe class="w-100 rounded" height="400" 
                        src="https://www.youtube.com/embed/JKpn0UuFHTc" 
