    ...
    <div class="row gx-0 align-items-center">
        ...
        <div class="col-lg-4 text-center text-lg-end">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <a href="#"><small class="me-3 text-dark"><i class="fa fa-user text-primary me-2"></i>Welcome <?php echo $nom_user;?></small></a>
                <a href="registrar.php"><small class="me-3 text-dark"><i class="fa fa-user text-primary me-2"></i>Registro</small></a>
                <a href="../index.php"><small class="me-3 text-dark"><i class="fa fa-sign-in-alt text-primary me-2"></i>Acceso</small></a>
                <div class="dropdown">
                    <a href="#" class="dropdown-toggle text-dark" data-bs-toggle="dropdown"><small><i class="fa fa-home text-primary me-2"></i> Panel de Control</small></a>
