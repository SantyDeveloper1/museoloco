                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-2">
                        <div class="footer-item">
                            ...
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Caracteristicas</a>
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Atracciones</a>
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Entradas</a>
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Blogs</a>
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Contactactanos</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item">
                            ...
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Descargar</a>
                            <a href="#"><i class="fas fa-angle-right me-2"></i> Apoyo</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <p class="text-white mb-0">Abancay - Apurimac</p>
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="fas fa-envelope text-primary me-3"></i>
                                <p class="text-white mb-0">ramirezlimasdanny@gmail.com</p>
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="fa fa-phone-alt text-primary me-3"></i>
                                <p class="text-white mb-0">(+51) 71104924</p>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                                <i class="fab fa-firefox-browser text-primary me-3"></i>
                                <p class="text-white mb-0">ramirez@gmail.com</p>
                            </div>
                            <div class="d-flex">
